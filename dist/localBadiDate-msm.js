...
(function (global, factory) {
    ...
    const DeltaT = (datetime) => {
        ...
        switch (true) {
            ...
            case y < 1600:
                u = (y - 1000) / 100;
                return polynomial(u, [1574.2, -556.01, 71.23472, 0.319781, -0.8503463, -5050998e-9, 0.0083572073]);
            case y < 1700:
                t = y - 1600;
                return polynomial(t, [120, -0.9808, -0.01532, 1 / 7129]);
            case y < 1800:
                t = y - 1700;
                return polynomial(t, [8.83, 0.1603, -59285e-7, 0.00013336, -1 / 1174000]);
            case y < 1860:
                t = y - 1800;
                return polynomial(t, [13.72, -0.332447, 0.0068612, 0.0041116, -37436e-8, 0.0000121272, -1.699e-7, 0.000000000875]);
            case y < 1900:
                t = y - 1860;
                return polynomial(t, [7.62, 0.5737, -0.251754, 0.01680668, -4473624e-10, 1 / 233174]);
            case y < 1920:
                t = y - 1900;
                return polynomial(t, [-2.79, 1.494119, -0.0598939, 0.0061966, -197e-6]);
            case y < 1941:
                t = y - 1920;
                return polynomial(t, [21.20, 0.84493, -0.0761, 0.0020936]);
            case y < 1961:
                t = y - 1950;
    ...
    /** See AA p144 */
    const sunMeanAnomaly = [357.52772, 35999.050340, -1603e-7, -1 / 300000];
    /** See AA p163 Eq 25.2 */
    ...
    /** See AA p144 */
    const moonArgumentOfLatitude = [93.27191, 483202.017538, -36825e-7, 1 / 327270];
    /** See AA p144 */
    ...
    /** See AA p144 */
    const moonMeanElongation = [297.85036, 445267.111480, -19142e-7, 1 / 189474];
    ...
    const clockLocations = {
        ...
        Iceland: [[[-25, 63.0], [-12.8, 63.0], [-12.8, 66.8], [-25, 66.8]]],
    ...
    const clockLocationFromPolygons = (latitude, longitude) => {
        ...
        if (latitude < 57.0 && longitude > -129 && longitude < 172.0) {
            return undefined;
        }
        ...
        // }
        if (longitude > -25 && longitude < -12.8) {
    ...
    class LocalBadiDate {
        ...
        _setInputDateToCorrectDay(date, latitude, longitude) {
            if (luxon__namespace.DateTime.isDateTime(date)) {
